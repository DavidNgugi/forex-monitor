        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className={cn(
                "px-6 py-3 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2",
            ...
            >
              ...
              <span>{isLoading ? 'Loading...' : 'Add Pair'}</span>
            </button>
          </div>
        </div>
